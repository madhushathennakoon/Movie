    ...
    <div className="cursor-pointer">
      ...
      <div className="max-w-40 p-3  mt-6 group">
        <a href="#">
          <h3
            title={title}
            className="text-sm font-bold tracking-tight text-gray-900 dark:text-white transition-colors duration-300 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 line-clamp-2"
          >
            {title}
          </h3>
        </a>
